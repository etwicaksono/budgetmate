...
import { transactionService, Transaction, TransactionFilters, TransactionsResponse } from '@/services/transactionService';
...
export function useTransactions(initialFilters?: Partial<TransactionFilters>): UseTransactionsResult {
  ...
  const [meta, setMeta] = useState<TransactionsResponse['meta']>({
    page: 1,
    limit: APP_CONFIG.pagination.transactionsPerPage,
