/**
 * OpenAI-Compatible LLM Provider (shared base)
 *
 * Several providers (SwiftRouter, VyceAI, ...) expose the exact OpenAI
 * chat-completions protocol and differ only in baseURL, API key and model list.
 * They all share this implementation and only supply those three values.
 *
